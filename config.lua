...
Config.Locations = {
    ...
    ["duty"] = {
        [1] = vector3(300.92, -595.23, 43.28),
        [2] = vector3(-254.88, 6324.5, 32.58),
    },
    ["vehicle"] = {
        [1] = vector4(333.93, -574.4, 28.8, 337.98),
        [2] = vector4(-234.28, 6329.16, 32.15, 222.5),
        [3] = vector4(326.68, -571.13, 28.8, 334.01),
    },
    ["helicopter"] = {
        [1] = vector4(351.66, -588.37, 74.16, 340.09),
        [2] = vector4(-475.43, 5988.353, 31.716, 31.34),
    },
    ["armory"] = {
        [1] = vector3(310.31, -602.9, 43.28),
        [2] = vector3(-245.13, 6315.71, 32.82),
    },
    ["roof"] = {
        [1] = vector4(327.18, -603.91, 43.28, 339.28),
    },
    ["main"] = {
        [1] = vector4(338.54, -583.85, 74.16, 250.02),
    },
    ["beds"] = {
        [1] = {coords = vector4(324.2, -583.01, 44.2, 338.39), taken = false, model = 2117668672},
        [2] = {coords = vector4(322.74, -587.01, 44.2, 156.87), taken = false, model = 2117668672},
        [3] = {coords = vector4(319.3, -581.3, 44.2, 334.74), taken = false, model = 2117668672},
        [4] = {coords = vector4(317.75, -585.29, 44.2, 150.71), taken = false, model = 2117668672},
        [5] = {coords = vector4(314.5, -583.96, 44.2, 160.24), taken = false, model = 2117668672}, 
        [6] = {coords = vector4(311.2, -582.81, 44.2, 149.3), taken = false, model = 2117668672},
        [7] = {coords = vector4(313.81, -579.18, 44.2, 336.78), taken = false, model = 2117668672},
        [8] = {coords = vector4(307.74, -581.53, 44.2, 159.63), taken = false, model = 2117668672},
        [9] = {coords = vector4(309.23, -577.71, 44.2, 339.95), taken = false, model = 2117668672}, 
        --paleto
