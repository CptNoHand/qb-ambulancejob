...
Config.Locations = {
    ...
    ["vehicle"] = {
        [1] = vector4(337.19, -571.51, 28.8, 337.7),
        [2] = vector4(-234.28, 6329.16, 32.15, 222.5),
        [3] = vector4(325.97, -567.74, 28.81, 339.75),
    },
    ["helicopter"] = {
    ...
    ["roof"] = {
        [1] = vector4(507.26, -4744.89, 500.15, 245.5),
    },
    ["main"] = {
        [1] = vector3(331.17, -592.82, 43.28),
    },
    ["beds"] = {
        [1] = {coords = vector4(366.52, -581.61, 44.21, 250.78), taken = false, model = 2117668672},
        [2] = {coords = vector4(354.34, -600.11, 44.22, 244.69), taken = false, model = 2117668672},
        [3] = {coords = vector4(359.54, -586.18, 44.2, 70.93), taken = false, model = 2117668672},
        [4] = {coords = vector4(364.74, -585.82, 44.21, 249.58), taken = false, model = 2117668672},
        [5] = {coords = vector4(363.69, -588.99, 44.21, 248.82), taken = false, model = 2117668672}, 
        [6] = {coords = vector4(359.35, -586.18, 44.2, 250.24), taken = false, model = 2117668672},
        [7] = {coords = vector4(361.14, -581.19, 44.19, 248.5), taken = false, model = 2117668672}, 
        --paleto
